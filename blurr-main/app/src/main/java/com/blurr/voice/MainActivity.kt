...
class MainActivity : BaseNavigationActivity() {
    ...
    private fun setupProBanner() {
        ...
        // Everyone has Pro access now, so the upgrade banner stays hidden permanently.
    ...
    private fun updateTaskCounter() {
        // Everyone is Pro now, so the task limit tag is never shown.
        tasksLeftTag.visibility = View.GONE
    }

    private fun updateBillingStatus() {
        // Everyone has Pro access; always show the Pro tag and hide the upgrade banner.
